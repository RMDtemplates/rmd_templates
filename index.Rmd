...
<div style="height: 20px; display: block; background-color: #fff;" class="text-center"><strong class="text-danger"><i class="fa fa-warning"></i> This site is still under construction. Sorry for the inconvenience</strong></div>
<div class="jumbotron">
